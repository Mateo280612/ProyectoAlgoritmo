...
Funcion ejercicioS4
	...
	Escribir "Ingrese lado uno del triangulo: ";
	Leer L1;
	Escribir "Ingrese lado dos del triangulo: ";
	Leer L2;
...
Funcion ejercicioC5
	...
	Escribir "Ingrese la hora de entrada del vehiculo (Fomrato de horas)";
	leer h;
	Escribir "Ingrese los minutos";
	leer m;
	
	Escribir "Ingrese las hora de salida en el estacionamiento (Formato de horas)";
	leer hs;
	Escribir "Ingrese los minutos";
	leer ms;
...
Funcion ejercicioC10
	...
	Leer num2
	Escribir "Ingrese operador: (+,-,*,/,mod,div)"
	Leer op
	Segun op Hacer
		"+":
			result=num1+num2
